...
pub struct CloudflareImagesStorage {
    account_id: String,
    api_token: String,
    account_hash: String,
}

impl CloudflareImagesStorage {
...
impl ImageStorage for CloudflareImagesStorage {
...
mod tests {
    ...
    async fn test_get_public_url() {
        let storage = CloudflareImagesStorage::new("acc-id", "token", "hash");
